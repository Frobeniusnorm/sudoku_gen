    ...
    for i in 0..9 {
        for j in 0..9 {
            if s[i][j] == 0 {
                ...
                let influenced = &influenced_cells(s, i, j);
                        ...
                        loop {
                            ...
                            for inf in 0..influenced.len() {
                                if forposs[inf] >= 0 {
                                    ...
                                    if poss_count == 1 && poss_val as i32 != forposs[inf] {
                                        changed = true;
                                        forposs[inf] = poss_val as i32;
                                        s[i][j] = poss_val as i32;
                                    }
                                }
                            }
                            if !changed {
                ...
                for inf in 0..influenced.len() {
                    ...
                    if same {
                        s[influenced[inf].0][influenced[inf].1] = certain[inf][0];
